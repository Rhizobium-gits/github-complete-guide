...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/theme-settings.png}
\caption{テーマ設定画面（Appearance）}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/shortcuts.png}
\caption{?キーで表示されるショートカット一覧}
\end{figure}
