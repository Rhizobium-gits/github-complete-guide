...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/diagram-fork-flow.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/diagram-oss-workflow.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/fork-pr.png}
\caption{ForkリポジトリからPull Requestを作成する画面}
\end{figure}
