...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/readme-display.png}
\caption{リポジトリトップページでREADMEが表示されている様子}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/collapsible.png}
\caption{折りたたみの展開前と展開後}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/wiki-settings.png}
\caption{Wiki有効化の設定画面}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/license-select.png}
\caption{GitHubのライセンス選択UI}
\end{figure}
