...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/github-desktop.png}
\caption{GitHub Desktopのメイン画面}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/github-mobile.png}
\caption{GitHub Mobileのメイン画面}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/diagram-claude-code.png}
\end{figure}
