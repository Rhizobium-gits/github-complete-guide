...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/vscode-git.png}
\caption{VS Codeのソース管理パネル全体像}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/github-dev.png}
\caption{github.devの画面（ブラウザ内にVS Codeが表示されている様子）}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/vscode-claude.png}
\caption{VS Code内のClaude Codeパネル}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/marketplace.png}
\caption{インストール済みアプリの管理画面}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/webhook-settings.png}
\caption{Webhook設定画面}
\end{figure}
