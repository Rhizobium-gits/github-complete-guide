...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/diagram-semver.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/release-create.png}
\caption{リリース作成画面。タグ選択、タイトル入力、リリースノート記入欄、Generate release notesボタンが見える状態}
\end{figure}
