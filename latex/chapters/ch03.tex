...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/signup.png}
\caption{GitHubトップページの Sign up ボタン}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/email-verify.png}
\caption{メール認証コード入力画面}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/2fa-setup.png}
\caption{2FA設定画面}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/profile-settings.png}
\caption{プロフィール設定画面}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/profile-readme.png}
\caption{プロフィールREADMEが表示されたプロフィールページ}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/notifications-settings.png}
\caption{通知設定画面}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/achievements.png}
\caption{プロフィールページのAchievementsバッジ表示エリア}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/contribution-graph.png}
\caption{コントリビューショングラフの表示例}
\end{figure}
