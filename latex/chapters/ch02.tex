...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/xcode-install.png}
\caption{xcode-select インストールダイアログ}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/git-for-windows.png}
\caption{Git for Windows インストーラー}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/git-version.png}
\caption{git --version の出力例}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/email-settings.png}
\caption{GitHub Email設定画面でnoreplyアドレスが表示されている状態}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{images/vscode-extensions.png}
\caption{VS Code公式サイトのダウンロードページ}
\end{figure}
