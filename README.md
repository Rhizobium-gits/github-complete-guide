...
| # | トピック | 内容 |
|---|---------|------|
| 01 | [Gitとは何か](docs/01-what-is-git.md) | Git/GitHubの違い、歴史と功績、バージョン管理の概念 |
...
| 20 | [READMEとドキュメント](docs/20-readme-docs.md) | READMEとは何か、書き方、ジャンル別テンプレ、Markdown、バッジ |
...
| # | トピック | 内容 |
|---|---------|------|
| 25 | [ファイルの拡張子と言語](docs/25-file-extensions.md) | 拡張子一覧、言語判定、設定ファイル、文字コード |
| 26 | [GitHubアプリの比較](docs/26-github-apps.md) | Web/Desktop/CLI/Mobile/IDE拡張の使い分け |
